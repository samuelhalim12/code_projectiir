...
class KNearestNeighbors implements Classifier
{
    ...
    protected function predictSample(array $sample)
    {
        ...
        foreach (array_keys($distances) as $index) {
            // pengecekan apakah target tersebut ada untuk mengatasi error index offset
    ...
    private function kNeighborsDistances(array $sample): array
    {
        ...
        // aslinya asort($distances) namun diubah menjadi arsort($distances) karena disini menggunakan coefficient
        // jadi tetangga dicari adalah yang terjauh
        arsort($distances);
